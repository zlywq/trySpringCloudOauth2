...
public interface FeignClientPrvdRes2L2 {
	
	@RequestMapping(method = RequestMethod.GET, value="/info1/procid")
	public String getServiceProcid();
	
	@RequestMapping(method = RequestMethod.GET, value="/postprvdres1/postid/{postId}")
	public BbsPost getByPostId(@PathVariable("postId") long postId) ;
	
	@RequestMapping(method = RequestMethod.GET, value="/postprvdres1/postid2/{postId}")
	public RestActResultTBbsPost getByPostId2(@PathVariable("postId") long postId) ;
	
	@RequestMapping(method = RequestMethod.GET, value="/postprvdres1/getPosts1")
	public BbsPost[] getPosts1();
	
	@RequestMapping(method = RequestMethod.GET, value="/postprvdres1/getPosts2")
	public RestActResultTBbsPostList getPosts2();
	
	@RequestMapping(method = RequestMethod.POST, value="/postprvdres1/insertByJson")
	public RestActResultTLong insert(BbsPost post);
	
	@RequestMapping(method = RequestMethod.POST, value="/postprvdres1/updateByJson")
	public RestActResultTLong update(BbsPost post);
	
	@RequestMapping(method = RequestMethod.POST, value="/postprvdres1/delete/{postId}")
