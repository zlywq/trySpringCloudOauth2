...
import sprssozdemo1.sprcldWeb3.feign.FeignClientPrvdRes2L1;
...
@RestController
@RequestMapping("/postprvdres2l1feign")
public class PostPrvdRes2L1FeignController {
	
	protected final Logger logger = LoggerFactory.getLogger(getClass());

	@Autowired
	FeignClientPrvdRes2L1 feignClient1;
