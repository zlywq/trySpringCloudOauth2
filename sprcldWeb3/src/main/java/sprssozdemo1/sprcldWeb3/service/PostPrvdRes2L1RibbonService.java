...
@Service
public class PostPrvdRes2L1RibbonService {
//	@Autowired
//	private RestTemplate restTemplate;
	...
	public BbsPost getByPostId(long postId) {
		// http://服务提供者的serviceId/url
		String url = urlForProvider1 + "postprov1/postid/{postId}"  ;
	...
	public RestActResultTBbsPost getByPostId2(long postId) {
		// http://服务提供者的serviceId/url
		String url = urlForProvider1 + "postprov1/postid2/{postId}"  ;
...
//		String url = urlForProvider1 + "postprov1/getById1" ;
...
//		String url = urlForProvider1 + "postprov1/getById2" ;
//		Map<String,Object> mpParam = new HashMap<>();
//		mpParam.put("postId", postId);
//		//这里用泛型发现有编译问题，改用显式类型
...
//	}
	...
	public BbsPost[] getPosts1() {
		String url = urlForProvider1 + "postprov1/getPosts1" ;
	...
	public RestActResultTBbsPostList getPosts2() {
		String url = urlForProvider1 + "postprov1/getPosts2" ;
	...
	public RestActResultTLong insert(BbsPost post) {
		try{
			String url = urlForProvider1 + "postprov1/insertByJson" ;
...
//			return this.restTemplate.postForObject(url, mpData, RestActResultTLong.class);
	...
	public RestActResultTLong update(BbsPost post, Principal puser) {
		try{
			String url = urlForProvider1 + "postprov1/updateByJson" ;
...
//			}
	...
	public RestActResultTLong delete(long postId) {
		try{
			String url = urlForProvider1 + "postprov1/delete/{postId}" ;
